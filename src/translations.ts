...
export const translations = {
  en: {
    ...
    consistencyDescription: 'How your study habit is changing over the last four weeks.',
    ...
    bestWeek: 'Best Week',
    strongestConsistency: 'Most Consistent',
    longest: 'LONGEST',
    ...
    recommendUnderstudied: "This subject needs more attention this week:",
  ...
  ku: {
    ...
    bestStudyTime: 'باشترین کاتی خوێندن',
    studyTimeDistribution: 'دابەشبوونی کاتی خوێندن',
    consistencyTrend: 'ڕەوتی بەردەوامی',
    consistencyDescription: 'چۆنیەتی گۆڕانی خوێندنت لە چوار هەفتەی ڕابردوو.',
    vsPreviousWeek: 'بەراورد بە هەفتەی پێشوو',
    trend: 'ڕەوت',
    improving: 'باشتر دەبێت',
    declining: 'خراپتر دەبێت',
    stable: 'جێگیرە',
    weeklyAverage: 'ناوەندی هەفتانە',
    bestWeek: 'باشترین هەفتە',
    strongestConsistency: 'بەردەوامترین',
    longest: 'درێژترین',
    ...
    recommendUnderstudied: 'ئەم بابەتە ئەم هەفتەیە پێویستی بە سەرنجی زیاتر هەیە:',
    ...
    breakComplete: 'پشوودان تەواو بوو',
